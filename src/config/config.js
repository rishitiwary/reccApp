...
export const GEMINI_API_KEY = 'AIzaSyCWcWV7vsy_sC4zx6vIUcCeGHIWb4DLgM4'; // Replace with your actual API key

// live key =rzp_live_wJGpkxo3RYNzoB
// test key = rzp_test_95RW1GRw2oKT6Z